        ...
        <Card className="border-border/50 shadow-soft">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="font-heading text-xl">Donor Profile</CardTitle>
              </div>
              {!editing && (
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input type="date" value={profile.dateOfBirth} disabled={!editing} onChange={(e) => setProfile({ ...profile, dateOfBirth: e.target.value })} />
            </div>
            <div className="space-y-2">
              <Label>Gender</Label>
              <Select value={profile.gender} onValueChange={(v) => setProfile({ ...profile, gender: v })} disabled={!editing}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
